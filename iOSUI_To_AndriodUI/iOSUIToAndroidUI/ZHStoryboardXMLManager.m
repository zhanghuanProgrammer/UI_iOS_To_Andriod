...
+ (NSArray *)getAllViewWithDic:(NSDictionary *)MyDic andXMLHandel:(ReadXML *)xml {
    ...
    [xml getTargetNodeArrWithName:@"view"
                          withDic:MyDic
                         withArrM:arrMSub
                       notContain:@[ @"view", @"tableViewCell", @"collectionViewCell" ]
                      withSuccess:NO];
    [xml getTargetNodeArrWithName:@"tableViewCell"
                          withDic:MyDic
                         withArrM:arrMSub
                       notContain:@[ @"view", @"tableViewCell", @"collectionViewCell" ]
                      withSuccess:NO];
    [xml getTargetNodeArrWithName:@"collectionViewCell"
                          withDic:MyDic
                         withArrM:arrMSub
                       notContain:@[ @"view", @"tableViewCell", @"collectionViewCell" ]
                      withSuccess:NO];
...
+ (NSArray *)getViewControllerCountNamesWithAllViewControllerArrM:(NSArray *)arrM {
    ...
    for (NSDictionary *dic in arrM) {
        if (dic[@"customClass"] != nil) [arrMName addObject:dic[@"customClass"]];
    }
    return arrMName;
}

/**获取某个ViewController所有的tableViewCell*/
+ (NSArray *)getAllTableViewCellNamesWithViewControllerDic:(NSDictionary *)dic
                                              andXMLHandel:(ReadXML *)xml {
    NSMutableArray *arrM = [NSMutableArray array];
    
    NSDictionary *tempDic = [xml getDicWithCondition:@{
                                                       @"customClass" : [xml dicNodeValueWithKey:@"customClass" ForDic:dic]
                                                       }
                                             withDic:dic];
...
+ (NSDictionary *)getAllTableViewCellAndIdWithViewControllerDic:(NSDictionary *)dic
                                                   andXMLHandel:(ReadXML *)xml {
...
+ (NSArray *)getTableViewCellNamesWithViewControllerDic:(NSDictionary *)dic
                                           andXMLHandel:(ReadXML *)xml {
    ...
    //先找到tableView
    NSMutableArray *arrMSub = [NSMutableArray array];
    [xml getTargetNodeArrWithName:@"tableView"
                          withDic:tempDic
                         withArrM:arrMSub
                       notContain:@[ @"tableView", @"collectionView" ]
                      withSuccess:NO];
    ...
    for (NSDictionary *dicSub in arrMSub) {
        ...
        for (NSDictionary *dicSubNew in arrMSubNew) {
            ...
            NSString *customClassTableViewCell =
            [xml dicNodeValueWithKey:@"customClass" ForDic:dicSubNew];
...
+ (NSArray *)getAllCollectionViewCellNamesWithViewControllerDic:(NSDictionary *)dic
                                                   andXMLHandel:(ReadXML *)xml {
    NSMutableArray *arrM = [NSMutableArray array];
    ...
    for (NSDictionary *dicSub in arrMSub) {
        NSString *customClassCollectionViewCell =
        [xml dicNodeValueWithKey:@"customClass" ForDic:dicSub];
...
+ (NSDictionary *)getAllCollectionViewCellAndIdWithViewControllerDic:(NSDictionary *)dic
                                                        andXMLHandel:(ReadXML *)xml {
    NSMutableDictionary *dicM = [NSMutableDictionary dictionary];
...
+ (NSMutableDictionary *)
getAllCollectionViewAndCollectionViewCellNamesWithViewControllerDic:(NSDictionary *)dic
andXMLHandel:(ReadXML *)xml {
    ...
    //先找到collectionView
    NSMutableArray *arrMSub = [NSMutableArray array];
    [xml getTargetNodeArrWithName:@"collectionView"
                          withDic:tempDic
                         withArrM:arrMSub
                       notContain:@[ @"tableView", @"collectionView" ]
                      withSuccess:NO];
    ...
    for (NSDictionary *dicSub in arrMSub) {
        ...
        NSString *customClassCollectionView =
        [xml dicNodeValueWithKey:@"customClass" ForDic:dicSub];
...
+ (NSArray *)getCollectionViewCellNamesWithViewControllerDic:(NSDictionary *)dic
                                                andXMLHandel:(ReadXML *)xml {
...
+ (NSArray *)getAllCollectionViewCellNamesWithConditionDic:(NSDictionary *)tempDic
                                              andXMLHandel:(ReadXML *)xml
                                                    toArrM:(NSMutableArray *)arrM {
    if (arrM == nil) { arrM = [NSMutableArray array]; }
        ...
        if (childArr != nil) {
            for (id obj in childArr) {
                if ([obj isKindOfClass:[NSDictionary class]]) {
                    [self getAllCollectionViewCellNamesWithConditionDic:obj
                                                           andXMLHandel:xml
                                                                 toArrM:arrM];
                }
            }
...
+ (NSDictionary *)getAllViewWithAllViewControllerArrM:(NSArray *)arrM andXMLHandel:(ReadXML *)xml {
    ...
    for (NSDictionary *dic in arrM) {
        ...
        [xml getDicArrFormPathArr:@[ @"view", @"subviews" ]
                        withIndex:0
                          withDic:tempDic
                        addToArrM:allDic];
...
/**嵌套获取所有View*/
+ (void)getAllViewWithConditionDic:(NSDictionary *)tempDic
                      andXMLHandel:(ReadXML *)xml
                            toDicM:(NSMutableDictionary *)dicM {
    
    if (dicM == nil) { dicM = [NSMutableDictionary dictionary]; }
...
/**获取所有OutletView*/
+ (NSDictionary *)getAllOutletViewWithAllViewControllerArrM:(NSArray *)arrM
                                               andXMLHandel:(ReadXML *)xml {
...
/**获取所有CellView*/
+ (NSDictionary *)getAllCellViewWithAllViewControllerArrM_XIB:(NSArray *)arrM
                                                 andXMLHandel:(ReadXML *)xml {
...
/**嵌套获取所有CellView*/
+ (void)getAllCellViewWithConditionDic_XIB:(NSDictionary *)tempDic
                              andXMLHandel:(ReadXML *)xml
                                    toDicM:(NSMutableDictionary *)dicM {
...
+ (NSDictionary *)getAllViewCustomAndIdWithAllViewControllerArrM:(NSArray *)arrM
                                                    andXMLHandel:(ReadXML *)xml {
...
/**获取所有View的CustomClass与对应的id */
+ (NSDictionary *)getAllViewCustomAndIdWithAllViewArrM_XIB:(NSArray *)arrM
                                              andXMLHandel:(ReadXML *)xml {
...
+ (void)getAllViewCustomAndIdWithConditionDic:(NSDictionary *)tempDic
                                 andXMLHandel:(ReadXML *)xml
                                       toDicM:(NSMutableDictionary *)dicM {
...
+ (NSDictionary *)getAllViewCustomAndNameWithAllViewControllerArrM:(NSArray *)arrM
                                                      andXMLHandel:(ReadXML *)xml {
...
/**获取所有View的CustomClass与对应的控件真名*/
+ (NSDictionary *)getAllViewCustomAndNameWithAllViewArrM_XIB:(NSArray *)arrM
                                                andXMLHandel:(ReadXML *)xml {
...
+ (void)getAllViewCustomAndNameWithConditionDic:(NSDictionary *)tempDic
                                   andXMLHandel:(ReadXML *)xml
                                         toDicM:(NSMutableDictionary *)dicM {
...
+ (NSArray *)getViewControllerSubViewsWithViewControllerDic:(NSDictionary *)dic
                                               andXMLHandel:(ReadXML *)xml {
    ...
    NSDictionary *mySubDic =
    [xml getDicFormPathArr:@[ @"view", @"subviews" ] withIndex:0 withDic:tempDic];
...
/**获取某个ViewController 的 view.subviews 包括view.subviews的子View  不包括tableViewCell
 * 和collectionViewCell的子view*/
+ (NSArray *)getAllViewControllerSubViewsWithViewControllerDic:(NSDictionary *)dic
                                                  andXMLHandel:(ReadXML *)xml {
...
/**获取某个tableViewCell 和collectionViewCell 的 view.subviews 包括view.subviews的子View
 * 不包括tableViewCell 和collectionViewCell的子view*/
+ (NSArray *)getAllCellSubViewsWithViewControllerDic:(NSDictionary *)dic
                                        andXMLHandel:(ReadXML *)xml {
...
+ (NSArray *)getAllViewControllerSubViewsWithConditionDic:(NSDictionary *)tempDic
                                             andXMLHandel:(ReadXML *)xml
                                                   toArrM:(NSMutableArray *)arrM {
    ...
    for (NSDictionary *subDic in [xml childDic:tempDic]) {
        if ([xml checkNodeValue:[xml dicNodeValueWithKey:@"customClass" ForDic:subDic]]) {
            NSString *idStr = [xml dicNodeValueWithKey:@"id" ForDic:subDic];
            if ([arrM containsObject:idStr] == NO) { [arrM addObject:idStr]; }
        }
        if ([[xml dicNodeName:subDic] isEqualToString:@"tableView"] == NO &&
            [[xml dicNodeName:subDic] isEqualToString:@"collectionView"] == NO) {
            //对每一个子view进行获取
            NSMutableArray *allDic = [NSMutableArray array];
            [xml getDicArrFormPathArr:@[ @"subviews" ] withIndex:0 withDic:subDic addToArrM:allDic];
            for (NSDictionary *subDic in allDic) {
                [self getAllViewControllerSubViewsWithConditionDic:subDic
                                                      andXMLHandel:xml
                                                            toArrM:arrM];
            }
        }
...
+ (NSDictionary *)getTableViewCellSubViewsIdWithViewControllerDic:(NSDictionary *)dic
                                                     andXMLHandel:(ReadXML *)xml {
    ...
    for (NSDictionary *dicSub in arrMSub) {
        NSString *customClassTableViewCell = [xml dicNodeValueWithKey:@"customClass" ForDic:dicSub];
        NSDictionary *mySubDic =
        [xml getDicFormPathArr:@[ @"tableViewCellContentView", @"subviews" ]
                     withIndex:0
                       withDic:dicSub];
...
+ (NSDictionary *)getCollectionViewCellSubViewsIdWithViewControllerDic:(NSDictionary *)dic
                                                          andXMLHandel:(ReadXML *)xml {
    NSMutableDictionary *dicM = [NSMutableDictionary dictionary];
    NSDictionary *tempDic     = [xml getDicWithCondition:@{
                                                           @"customClass" : [xml dicNodeValueWithKey:@"customClass" ForDic:dic]
    ...
    for (NSDictionary *dicSub in arrMSub) {
        ...
        [xml dicNodeValueWithKey:@"customClass" ForDic:dicSub];
        NSDictionary *mySubDic =
        [xml getDicFormPathArr:@[ @"view", @"subviews" ] withIndex:0 withDic:dicSub];
...
+ (void)getViewAllCanotUseConstraintWithControllerDic:(NSDictionary *)dic
                                         andXMLHandel:(ReadXML *)xml
                                        withViewIdStr:(NSString *)viewIdStr
                           withCanoyUseConstraintArrM:(NSMutableArray *)CanoyUseConstraintArrM {
    if (CanoyUseConstraintArrM == nil) { CanoyUseConstraintArrM = [NSMutableArray array]; }
    ...
    //找到对应的节点 根据CustomClass找到的节点 如果CustomClass,就找id  因为有一个特殊的view
    //就是self.view
    [xml getTargetNodeArrWithKeyName:@"customClass"
                         andKeyValue:viewIdStr
                             withDic:tempDic
                            withArrM:allConstraints];
    
    //开始抽取其中的约束值
    for (NSDictionary *dicConstraint in allConstraints) { //其实就只有一个,因为custom唯一
        
        NSMutableArray *arrMSub = [NSMutableArray array];
        [xml getTargetNodeArrWithName:@"variation"
                              withDic:dicConstraint
                             withArrM:arrMSub
                           notContain:@[ @"subviews" ]
                          withSuccess:NO];
        
        for (NSDictionary
             *dicSub in arrMSub) { //其实还是只有一个,因为每一个控件里面只有一个constraints
            NSMutableArray *ViewConstraints = [NSMutableArray array];
            [xml getTargetNodeArrWithName:@"exclude"
                                  withDic:dicSub
                                 withArrM:ViewConstraints
                               notContain:nil
                              withSuccess:NO];
            
            for (NSDictionary *unUseDic in ViewConstraints) {
                if ([xml dicNodeValueWithKey:@"reference" ForDic:unUseDic].length > 0) {
                    [CanoyUseConstraintArrM
                     addObject:[xml dicNodeValueWithKey:@"reference" ForDic:unUseDic]];
                }
            }
        }
    }
...
+ (void)getViewAllConstraintWithControllerDic:(NSDictionary *)dic
                                 andXMLHandel:(ReadXML *)xml
                                withViewIdStr:(NSString *)viewIdStr
                       withSelfConstraintDicM:(NSMutableDictionary *)selfConstraintDicM
                      withOtherConstraintDicM:(NSMutableDictionary *)otherConstraintDicM {
    
    if (selfConstraintDicM == nil) { selfConstraintDicM = [NSMutableDictionary dictionary]; }
    
    if (otherConstraintDicM == nil) { otherConstraintDicM = [NSMutableDictionary dictionary]; }
    ...
    [self getViewAllCanotUseConstraintWithControllerDic:dic
                                           andXMLHandel:xml
                                          withViewIdStr:viewIdStr
                             withCanoyUseConstraintArrM:CanoyUseConstraintArrM];
    ...
    for (NSDictionary *dicConstraint in allConstraints) { //其实就只有一个,因为custom唯一
        ...
        NSMutableArray *arrMSub = [NSMutableArray array];
        [xml getTargetNodeArrWithName:@"constraints"
                              withDic:dicConstraint
                             withArrM:arrMSub
                           notContain:@[
                                        @"tableViewCell", @"collectionViewCell", @"subviews", @"constraints"
                                        ]
                          withSuccess:NO];
        ...
        for (NSDictionary
             *dicSub in arrMSub) { //其实还是只有一个,因为每一个控件里面只有一个constraints
            NSMutableArray *ViewConstraints = [NSMutableArray array];
            [xml getTargetNodeArrWithName:@"constraint"
                                  withDic:dicSub
                                 withArrM:ViewConstraints
                               notContain:@[ @"subviews" ]
                              withSuccess:NO];
            ...
            for (NSDictionary *checkDic in ViewConstraints) {
                ...
                if ([CanoyUseConstraintArrM
                     containsObject:[xml dicNodeValueWithKey:@"id" ForDic:checkDic]]) {
                    continue;
                }
                
                if ([xml dicNodeValueWithKey:@"firstItem" ForDic:checkDic].length > 0 ||
                    [xml dicNodeValueWithKey:@"secondItem" ForDic:checkDic].length > 0) {
                    if (viewIdStr.length > 0 &&
                        [[xml dicNodeValueWithKey:@"firstItem" ForDic:checkDic]
                         isEqualToString:viewIdStr]) {
...
+ (void)getViewAllConstraintWithViewDic:(NSDictionary *)dic
                           andXMLHandel:(ReadXML *)xml
                          withViewIdStr:(NSString *)viewIdStr
                 withSelfConstraintDicM:(NSMutableDictionary *)selfConstraintDicM {
...
+ (void)getTableViewCellViewAllCanotUseConstraintWithControllerDic_XIB:(NSDictionary *)dic
                                                          andXMLHandel:(ReadXML *)xml
                                                         withViewIdStr:(NSString *)viewIdStr
                                            withCanoyUseConstraintArrM:
(NSMutableArray *)CanoyUseConstraintArrM {
    if (CanoyUseConstraintArrM == nil) { CanoyUseConstraintArrM = [NSMutableArray array]; }
...
+ (void)
getTableViewCellViewAllConstraintWithControllerDic_XIB:(NSDictionary *)dic
andXMLHandel:(ReadXML *)xml
withViewIdStr:(NSString *)viewIdStr
withSelfConstraintDicM:(NSMutableDictionary *)selfConstraintDicM
withOtherConstraintDicM:(NSMutableDictionary *)otherConstraintDicM {
    ...
    NSMutableArray *CanoyUseConstraintArrM = [NSMutableArray array];
    [self getTableViewCellViewAllCanotUseConstraintWithControllerDic_XIB:dic
                                                            andXMLHandel:xml
                                                           withViewIdStr:viewIdStr
                                              withCanoyUseConstraintArrM:CanoyUseConstraintArrM];
    ...
    for (NSDictionary *checkDic in allConstraints) {
        ...
        if ([xml dicNodeValueWithKey:@"firstItem" ForDic:checkDic].length > 0 ||
            [xml dicNodeValueWithKey:@"secondItem" ForDic:checkDic].length > 0) {
            if (viewIdStr.length > 0 && [[xml dicNodeValueWithKey:@"firstItem" ForDic:checkDic]
                                         isEqualToString:viewIdStr]) {
                [selfConstraints addObject:checkDic];
            } else
                [otherConstraints addObject:checkDic];
        ...
        if (arrTemp.count > 0) {
            for (NSInteger i = 0; i < arrTemp.count; i++) {
                ...
                if (firstItem.length > 0 && [self isSystemIdStr:firstItem] == NO &&
                    [firstItem isEqualToString:view] == NO) {
                    if ([self changeConstraintToDic:newSelfConstraintDicM
                                     withConstraint:subDic
                                       withViewName:firstItem]) {
        ...
        if (arrTemp.count > 0) {
            for (NSInteger i = 0; i < arrTemp.count; i++) {
                ...
                if (firstItem.length == 0 || [self isSystemIdStr:firstItem] == YES) {
                    ...
                    if (secondItem.length > 0 && [self isSystemIdStr:secondItem] == NO &&
                        [secondItem isEqualToString:view] == NO) {
                        if ([self changeConstraintToDic:newSelfConstraintDicM
                                         withConstraint:subDic
                                           withViewName:secondItem]) {
                            [arrTemp removeObject:subDic];
                            i--;
                        }
                    }
        ...
        if (arrTemp.count > 0) {
            for (NSInteger i = 0; i < arrTemp.count; i++) {
                ...
                if (firstItem.length == 0 || [self isSystemIdStr:firstItem] == YES) {
                    NSString *secondItem = [xml dicNodeValueWithKey:@"secondItem" ForDic:subDic];
                    if (secondItem.length > 0 && [self isSystemIdStr:secondItem] == NO &&
                        [secondItem isEqualToString:view]) {
                        if ([self changeConstraintToDic:newSelfConstraintDicM
                                         withConstraint:subDic
                                           withViewName:secondItem]) {
                            [arrTemp removeObject:subDic];
...
+ (BOOL)changeConstraintToDic:(NSMutableDictionary *)dic
               withConstraint:(NSDictionary *)constraintDic
...
/**建立一个父子和兄弟关系的链表*/
+ (void)createRelationShipWithControllerDic:(NSDictionary *)dic
                               andXMLHandel:(ReadXML *)xml
                                  WithViews:(NSMutableArray *)views
                        withRelationShipDic:(NSMutableDictionary *)relationShipDicM
                                     isCell:(BOOL)isCell {
    if (relationShipDicM == nil) { relationShipDicM = [NSMutableDictionary dictionary]; }
    ...
    [xml getTargetNodeArrWithName:@"subviews"
                          withDic:tempDic
                         withArrM:arrMSubViews
                       notContain:@[ @"subviews" ]
                      withSuccess:NO];
        ...
        for (NSDictionary *subDic in subViews) {
            ...
            if ([self isView:dicName].length > 0) {
                ...
                if (customClass.length > 0 && [views containsObject:customClass]) {
                    ...
                    [self recursiveCreateRelationShipWithDic:subDic
                                                andXMLHandel:xml
                                                   WithViews:views
                                         withRelationShipDic:relationShipDicM
                                          withFatherViewName:customClass];
                }
            }
        }
    }
...
/**嵌套建立一个父子和兄弟关系的链表*/
+ (void)recursiveCreateRelationShipWithDic:(NSDictionary *)dic
                              andXMLHandel:(ReadXML *)xml
                                 WithViews:(NSMutableArray *)views
                       withRelationShipDic:(NSMutableDictionary *)relationShipDicM
                        withFatherViewName:(NSString *)fatherViewName {
    ...
    if (subViewNames.count > 0) { [relationShipDicM setValue:subViewNames forKey:fatherViewName]; }
}

/**获取所有ViewController 的 self.view.subviews  格式 ViewController,CustomClass,id */
+ (NSDictionary *)getViewControllerSubViewsIdAndViewNameWithDic:(NSDictionary *)MyDic
                                                   andXMLHandel:(ReadXML *)xml
                                            withCustomClassDicM:(NSMutableArray *)CustomClassArrM {
    
    if (CustomClassArrM == nil) { CustomClassArrM = [NSMutableArray array]; }
    ...
    for (NSDictionary *dic in arrM) {
        ...
        for (NSDictionary *subDic in [xml childDic:mySubDic]) {
            [dicM setValue:[customClassViewController
                            stringByAppendingFormat:@"--%@", [xml dicNodeName:subDic]]
                    forKey:[xml dicNodeValueWithKey:@"id" ForDic:subDic]];
            if ([xml checkNodeValue:[xml dicNodeValueWithKey:@"customClass" ForDic:subDic]]) {
                NSMutableArray *subArr = [NSMutableArray array];
...
/**获取所有ViewController 的 TableViewCell.subviews  格式
 * ViewController,TableViewCell,CustomClass,id */
+ (NSDictionary *)getTableViewCellSubViewsIdAndViewNameWithDic:(NSDictionary *)MyDic
                                                  andXMLHandel:(ReadXML *)xml
                                           withCustomClassDicM:(NSMutableArray *)CustomClassArrM {
    NSMutableDictionary *dicM = [NSMutableDictionary dictionary];
    NSMutableArray *arrM      = [NSMutableArray array];
    ...
    for (NSDictionary *dic in arrM) {
        ...
        for (NSDictionary *dicSub in arrMSub) {
            ...
            for (NSDictionary *subDicTemp in [xml childDic:mySubDic]) {
                [dicM setValue:[customClassViewController
                                stringByAppendingFormat:@"--%@--%@", customClassTableViewCell,
                                [xml dicNodeName:subDicTemp]]
                        forKey:[xml dicNodeValueWithKey:@"id" ForDic:subDicTemp]];
                if ([xml checkNodeValue:[xml dicNodeValueWithKey:@"customClass"
                                                          ForDic:subDicTemp]]) {
                    NSMutableArray *subArr = [NSMutableArray array];
                    [subArr addObject:customClassViewController];
                    ...
                    [CustomClassArrM addObject:subArr];
                    //                    NSLog(@"%@  %@  %@
                    //                    %@",subArr[0],subArr[1],subArr[2],subArr[3]);
                }
            }
        }
    }
...
/**获取所有ViewController 的 CollectionViewCell.subviews  格式
 * ViewController,CollectionViewCell,CustomClass,id */
+ (NSDictionary *)getCollectionViewCellSubViewsIdAndViewNameWithDic:(NSDictionary *)MyDic
                                                       andXMLHandel:(ReadXML *)xml
                                                withCustomClassDicM:
(NSMutableArray *)CustomClassArrM {
    NSMutableDictionary *dicM = [NSMutableDictionary dictionary];
    NSMutableArray *arrM      = [NSMutableArray array];
    [xml getTargetNodeArrWithName:@"viewController" withDic:MyDic withArrM:arrM];
    for (NSDictionary *dic in arrM) {
        ...
        for (NSDictionary *dicSub in arrMSub) {
            ...
            for (NSDictionary *subDicTemp in [xml childDic:mySubDic]) {
                [dicM
                 setValue:[customClassViewController
                           stringByAppendingFormat:@"--%@--%@", customClassCollectionViewCell,
                           [xml dicNodeName:subDicTemp]]
                 forKey:[xml dicNodeValueWithKey:@"id" ForDic:subDicTemp]];
                if ([xml checkNodeValue:[xml dicNodeValueWithKey:@"customClass"
                                                          ForDic:subDicTemp]]) {
